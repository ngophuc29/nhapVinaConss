        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="course__img__wrapp">
                  <img src="./img/revit.jpg" alt="" class="course__img">
                </div>
            </div>
                  ...
                  <div class="tab-pane active pill_trans1" id="1a">
                    <div class="container">
                      <div style="margin-top: 50px;" class="row">
                        <div class="col-lg-6">
                          <img style="width: 100%;" src="img/revit-gif.jpg" alt="">
                        </div>
                        <div class="row">
                          <p>Revit là một phần mềm được xây dựng và phát triển bởi Autodesk để hỗ trợ thực hiện một dự án xây dựng theo quy trình BIM (Building Information Modeling). 
                            BIM là một quy trình và một phương pháp luận để tạo lập và quản lý các thông tin liên quan đến một dự án công trình ngay từ khâu thiết kế sơ bộ đến khi công trình được đưa vào vận hành. 
                            Revit giúp bạn tạo ra mô hình BIM kỹ thuật số 3D với các tính năng cho ba lĩnh vực chính của ngành AEC, (Kiến trúc, MEP- Cơ khí, Điện và Hệ thống ống nước, Kỹ thuật kết cấu). 
                            Revit giúp bạn làm việc với các đối tượng tham số, thay đổi nhanh chóng, cập nhật, cung cấp tài liệu xây dựng, ước tính số lượng và chi phí, phối hợp, hình ảnh hóa 3D, khả năng tương tác và tích hợp với các phần mềm khác. Revit giúp ích cho việc xây dựng cầu bằng cách cho phép bạn thiết kế và tạo lập hồ sơ thiết kế hoàn chỉnh một cách chính xác và nhanh chóng. Bạn có thể sử dụng Revit để vẽ và tạo bản vẽ kỹ thuật cho các chi tiết cấu trúc, tính toán các chỉ số liên quan đến khối lượng, khoảng cách, diện tích, chu vi, góc, sao chép dãy, tạo khối, vẽ mặt cắt, tạo góc lượn, chèn khối, xoay đối tượng theo 3 chiều và nhiều hơn nữa. Bạn cũng có thể chia sẻ và quản lý dữ liệu thiết kế cùng với các cộng sự và đối tác thông qua các dịch vụ của Autodesk. 
                            Revit là một phần mềm thiết kế xây dựng rất phổ biến và được tin cậy trên thế giới.</p>
                        </div>
                      </div>
                    </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form action="" method="post">
                ...
                <input type="hidden" name="tenkh" id="tenkh" value="revit">
